...
<body class="hold-transition skin-purple sidebar-mini">
	...
	<div class="wrapper">
				...
				<ul class="sidebar-menu">
					...
					<li class="treeview"><a href="#"> <i class="fa fa-cogs"></i>
						...
						<ul class="treeview-menu">
							...
							<li id="system-setting"><a href="${pageContext.request.contextPath}/user/findAll.do"> <i
							...
							<li id="system-setting"><a href="${pageContext.request.contextPath}/sysLog/findAll.do"> <i
					...
					<li class="treeview"><a href="#"> <i class="fa fa-cube"></i>
						...
						<ul class="treeview-menu">
							...
							<li id="system-setting"><a href="${pageContext.request.contextPath}/product/findAll.do">
		...
		<footer class="main-footer">
			...
			<strong>Copyright &copy; 2014-2017 <a href="http://www.bukaedu.cn">研究院研发部</a>.
	...
	<script src="${pageContext.request.contextPath}/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js">
	</script>
	...
	<script src="${pageContext.request.contextPath}/plugins/bootstrap-markdown/locale/bootstrap-markdown.zh.js">
	</script>

...
<body class="hold-transition skin-purple sidebar-mini">
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar">
            ...
            <div class="input-group">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li id="admin-index"><a href="all-admin-index.html"><i class="fa fa-dashboard"></i>
                            <span>首页</span></a></li>
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; 2014-2017 <a href="http://www.bukaedu.cn">研究院研发部</a>.</strong> All rights reserved.
        </footer>
        <!-- 底部导航 /-->
